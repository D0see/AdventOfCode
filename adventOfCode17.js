...
switch (num) {
    case '0' : {
        ...
        registers['A'] = Math.trunc(registers['A'] / combo);
    }
    case '1' : {
        //bxl
...
// The adv instruction (opcode 0) performs division. The numerator is the value in the A register. The denominator is found by raising 2 to 
// the power of the instruction's combo operand. (So, an operand of 2 would divide A by 4 (2^2); an operand of 5 would divide A by 2^B.) 
